...
const cardData = [
  {
    color: 'rgba(10,21,39,0.6)',
    title: '3-Agent AI Debate System',
    description: 'Three frontier AI models interrogate every shelf: Gemini 1.5 Pro analyses visually, GPT-4o challenges the economics, Groq LLaMA-3.1 stress-tests with local kirana context.',
    label: '🏆 Flagship Feature'
  },
  {
    color: 'rgba(10,21,39,0.6)',
    title: 'Zero-Friction Scanning',
    description: 'No app install. No signup. Any kirana owner sends a WhatsApp photo and receives a full AI analysis back — in Hindi — within 30 seconds.',
    label: '📸 WhatsApp Native'
  },
  {
    color: 'rgba(10,21,39,0.6)',
    title: 'Gemini 1.5 Pro Vision — 99% Accuracy',
    description: 'Detects every SKU on shelf, estimates stock levels, identifies facing errors and empty sections in a single glance.',
    label: '🎯 Vision Accuracy'
  },
  {
    color: 'rgba(10,21,39,0.6)',
    title: 'Hindi Voice Output',
    description: "The AI's restock plan is converted to natural Hinglish speech via ElevenLabs TTS. No literacy required — any shopkeeper can act on it.",
    label: '🎙️ ElevenLabs TTS'
  },
  {
    color: 'rgba(10,21,39,0.6)',
    title: 'Photo to Voice Plan — 30s',
    description: 'From shelf photo to actionable Hindi voice recommendation — complete AI pipeline running in under 30 seconds.',
    label: '⚡ End-to-End'
  },
  {
    color: 'rgba(10,21,39,0.6)',
    title: 'Neighbourhood Demand Map',
    description: 'Every scan aggregates to a pincode-level demand map updated weekly. The dataset HUL, ITC, Nestlé pay ₹50–100L/year for.',
    label: '🏘️ Aggregated Intel'
  }
];
